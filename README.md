...
<a href="https://github.com/Soflution1/SofDocs/releases/latest"><img src="docs/assets/download-mac.png" alt="Download Slate for macOS" height="62"></a>
&nbsp;&nbsp;
<a href="https://github.com/Soflution1/SofDocs/releases"><img src="docs/assets/download-win.png" alt="Download Slate for Windows" height="62"></a>
&nbsp;&nbsp;
<a href="https://github.com/Soflution1/SofDocs/releases"><img src="docs/assets/download-linux.png" alt="Download Slate for Linux" height="62"></a>
...
| --- | --- | --- | --- |
| **macOS** | Apple Silicon (aarch64) | ✅ Signed & notarized | [**Download `.dmg`**](https://github.com/Soflution1/SofDocs/releases/latest) |
| **macOS** | Intel (x86_64) | 🛠 Build from source | [Instructions](#-build-from-source) |
| **Windows** | x86_64 | 🔄 Via CI | [Releases](https://github.com/Soflution1/SofDocs/releases) |
| **Linux** | x86_64 | 🔄 Via CI | [Releases](https://github.com/Soflution1/SofDocs/releases) |
...
➡️ **Latest release:** [github.com/Soflution1/SofDocs/releases/latest](https://github.com/Soflution1/SofDocs/releases/latest)
...
- **Clean multi-line paste** — pasted text keeps proper line spacing instead of
  inheriting the source's foreign styling
- **Rubber-band (marquee) multi-selection:** drag a selection rectangle to grab
  multiple blocks, then move or delete them together
...
`crates/pdf-engine` so the desktop binary and the planned `wasm` build share the
exact same behavior. The frontend talks to whichever transport is available
...
This is a monorepo composed of Git submodules:

```
SofDocs/
├── apps/
│   ├── desktop/     → Slate desktop app (Tauri v2)        [Soflution1/sofdocs-desktop]
│   │   ├── src-tauri/        Rust shell + commands
│   │   └── crates/pdf-engine Shared PDF engine (desktop + WASM)
│   └── web/         → Web frontend
├── crates/
│   ├── core/        → Office document model (Word / Sheets / Slides)
│   ├── server/      → Backend services
│   └── wasm/        → WebAssembly build of the engine
├── LICENSE          → GNU AGPL-3.0
├── NOTICE           → Copyright & ONLYOFFICE attribution
└── ONLYOFFICE_PORT.md → AGPL port audit trail
```

Clone with submodules:

```bash
git clone --recurse-submodules https://github.com/Soflution1/SofDocs.git
```
...
- [x] Standalone native PDF reader & editor (**Slate**)
- [x] Per-character text formatting + full font catalog
- [x] Marquee multi-selection & block deletion
...
Issues and pull requests are welcome. Because parts of the engine are derived
from ONLYOFFICE under the AGPL, every derived module must keep its source
attribution and AGPL header — see [`ONLYOFFICE_PORT.md`](ONLYOFFICE_PORT.md) and
[`NOTICE`](NOTICE).
...
Portions of the office engine are derived from
